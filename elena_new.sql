...
INSERT INTO `film` (`id_film`, `nom_film`, `date_sortie`, `duree`, `synopsis`, `note`, `id_realisateur`, `affiche_film`) VALUES
	...
	(3, 'Mary Shelley', 2018, 120, 'La famille de Mary Wollstonecraft désapprouve quand elle et le poète Percy Shelley annoncent leur amour l\'un pour l\'autre. La famille est horrifiée lorsqu\'elle constate que le couple s\'est enfui, accompagné de la demi-soeur de Marie, Claire.', 4, 2, 'public/img/affiches/MaryShelley.jpeg'),
	...
	(10, 'Winter Break', 2023, 133, 'Un instructeur maussade d\'une école préparatoire de la Nouvelle-Angleterre reste sur le campus pendant les vacances de Noël pour garder une poignée d\'étudiants qui n\'ont nulle part où aller.', 4.1, 8, 'public/img/affiches/winterbreak.jpg'),
